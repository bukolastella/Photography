...
const RightSide = () => {
  ...
  return (
    <div
      className="bg-white h-[600px] lg:h-full w-full border-l shadow-[4px_8px_10px_0px_#00000020,-4px_4px_10px_0px#00000020]  p-[5%] sm:p-6 sm:pl-1 grid grid-cols-8 grid-rows-8 gap-1"
      ref={container}
    >
